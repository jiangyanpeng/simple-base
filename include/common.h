...
typedef enum MemoryType {
    ...
    MEM_ON_CUDA_HOST       = 3, /**< memory type normal cuda */
    MEM_ON_CUDA_DEV        = 4, /**< memory type normal cuda */
    MEM_ON_MEMORY_TYPE_MAX = 5  /**< the max number of memory type */
} MemoryType;
...
const static std::string MemTypeStr[MEM_ON_MEMORY_TYPE_MAX] = {
    "CPU",
    "OCL",
    "HEXAGON_DSP",
    "CUDA_HOST",
